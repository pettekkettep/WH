...
if(isset($_POST['comment']) && isset($_POST['newsid'])){
    ...
    add_comment_to_news($user, $_POST['comment'], $_POST['newsid']);
    $newsid = $_POST['newsid'];
    $user = $_POST['user'];
...
<div class="row row-style center-align">
    <div class="col-2">
        ...
        ?>
        <!--        <h4>Dziś:</h4>-->
        <!--        <p class="bold" style="color: lime">Nowa funkcjonalność: HODOWLA</p>-->
    </div>
    <div class="col-3">
    ...
    <div class="col-3">
        ...
        while($row = mysqli_fetch_assoc($result)){
            ...
            $rank = $row['rank'];
            $numer = $row['numer'];
            echo "<p class='narrow'><a href='fasolka_postac.php?id=$numer' class='wocolor'>$wlasciciel </a><span class='bold colored bit-bigger'>$rank</span> xp</p>";
        }
        ?>
    </div>
    <div class="col-2">
